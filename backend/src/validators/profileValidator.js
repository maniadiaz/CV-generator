...
const createProfileSchema = Joi.object({
  ...
  template: Joi.string()
    .valid('harvard_classic', 'harvard_modern')
    .optional()
    .messages({
      'any.only': 'Template must be either harvard_classic or harvard_modern'
    }),
  ...
  color_scheme: Joi.string()
    ...
    .optional()
    .messages({
      'string.max': 'Color scheme must not exceed 50 characters'
    }),
